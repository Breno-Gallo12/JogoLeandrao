function Background(context, canvasWidth, canvasHeight, jogador, jogador2) {
  ...
  this.arvolelongeLayer = new Layer(
    this.context,
    this.images[3],
    0,
    5,
