...
Jogador.prototype = {
  ...
  atualizar: function () {
    ...
    }if (((this.teclado.pressionada(Q) && this.cooldownAtaque1 === 0) || this.teclado.pressionada(W) && this.cooldownAtaque2 === 0) && (this.teclado.pressionada(SETA_DIREITA) || this.teclado.pressionada(SETA_ESQUERDA))) {
      this.isMoving = true;
      this.iniciarAtaque1();
      this.iniciarAtaque2();
    }
